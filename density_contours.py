...
def density_contours(ax,x,y,xmin,xmax,ymin,ymax,color,alpha,n_bin=10,label=None,scatter=None,sc_size=8,legend=False,level='sqrt'):
        '''
        ...
        parameters
        -------------------
        ax : the matplotlib axis object that you want to plot onto (not actually used!!!) 
